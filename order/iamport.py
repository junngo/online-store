...
# get token from iamport for connection
def get_token():
    access_data = {
...
# pre-paring payment - hand order id and amount to iamport
...
# checking transaction If It's okay - get real transaction information from iamport
